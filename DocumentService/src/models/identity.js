	...
	},
	{
		...
		toJSON: {
			transform: function (doc, ret) {
				...
				ret.expiration_date = ret.expiration_date
					? moment(ret.expiration_date).format('DD MMMM YYYY')
					: 'NA' // Format expiration_date
			},
		},
	}
)
 ...
 */
identityDocumentSchema.statics.isDocumentExist = async function (
	consumer,
	category,
	doctype
) {
...
/**
 * to parse the given expriration date into date object
 *
 * @param {string} expiration_date - date
 * @returns {Date} date object
 */
identityDocumentSchema.statics.toParseDate = async function (expiration_date) {
	return moment(expiration_date, 'DD-MM-YYYY').format('YYYY-MM-DD')
}
